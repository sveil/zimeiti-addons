...
<script type="text/javascript" charset="utf-8" src="https://caiji-api.oss-accelerate.aliyuncs.com/v10.3.1/main.min.js?v=<?php echo date('Hi'); ?>"></script>
<script type="text/javascript" src="./js/set-player.js?v=<?php echo date('Hi'); ?>"></script>
</body>
</html>
