...
<script type="text/javascript" src="https://caiji-api.oss-accelerate.aliyuncs.com/v10.3.1/main.min.js?v=<?php echo date('Hi'); ?>"></script>
<script type="text/javascript" src="./js/allplayer.js?v=<?php echo date('Hi'); ?>"></script>
