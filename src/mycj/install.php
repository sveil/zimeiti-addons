...
<script type="text/javascript">var my = {'name':'<?php echo $_COOKIE["admin_name"]; ?>',mac_version:'v10',mac_ver:'<?php echo $mac_ver['code']; ?>'};</script>
<script src="<?php echo $path; ?>static/js/jquery.js?v=<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
<script src="<?php echo $path; ?>static/layui/layui.js?v=<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
</head>
<body>
<div class="header">
    ...
    <fieldset class="layui-elem-field site-demo-button">
        ...
        <div class="protocol">
            <p>
                ...
                一、插件介绍： <br /> <br />
                本插件分为 <b>免费版</b> 和 <b>付费版</b>，免费版和付费版能采集到的资源都是一样的；区别在于<b style="color:#FF5722">付费版可使用自定义播放配置、一键定时任务、一键搜索最新资源、批量修改播放器、视频断点采集、视频幻灯图获取、采集交流群等 </b><br /><br />
                二、重要声明：  <br /> <br />
...
<script src="https://caiji-api.oss-accelerate.aliyuncs.com/V10/update.js?v=<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
<script>
